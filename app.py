...
class predict(Resource):
    def post(self):
       ...
       #sending in a dataframe and mulitple records
        ...
        #Turn predictions and return excel file as output
        result= result.tolist()
        predicted = pd.DataFrame(result, columns=['Location Accuracy'])
        
        return predicted.to_excel(r'location_predictions.xlsx')
...
if __name__ == "__main__":
    app.run(debug=True)
#host = 'http://127.0.0.1:5000/', port = 5000